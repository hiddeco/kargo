...
type FreightStatus struct {
	...
	PromotedTo map[string]PromotedStage `json:"promotedTo,omitempty" protobuf:"bytes,3,rep,name=promotedTo" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
